...
export default function SignUp() {
  ...
  function handleRegister(values: object) {
    setLoading(true);
    axios
  ...
  const inputClass =
    "peer block w-full rounded-lg border border-slate-300 bg-transparent px-2.5 pt-4 pb-2.5 text-sm text-slate-900 placeholder-transparent focus:border-slate-900 focus:ring-1 focus:ring-slate-900 focus:outline-none";
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4">
      ...
      >
        ...
        <div className="relative my-5">
          ...
          <p className="mt-1 text-xs text-red-500">{formik.touched.name && formik.errors.name}</p>
        </div>
        ...
        <div className="relative my-5">
          <input
            ...
            className={inputClass}
          />
          <label htmlFor="phone" className={labelClass}>{t("signup.phone")}</label>
          <p className="mt-1 text-xs text-red-500">{formik.touched.phone && formik.errors.phone}</p>
        </div>
        ...
        <div className="relative my-5">
          ...
          <p className="mt-1 text-xs text-red-500">{formik.touched.email && formik.errors.email}</p>
        </div>
        ...
        <div className="relative my-5">
          ...
          <p className="mt-1 text-xs text-red-500">{formik.touched.password && formik.errors.password}</p>
        </div>
        ...
        <div className="relative my-5">
          <input
            ...
            className={inputClass}
          />
          <label htmlFor="rePassword" className={labelClass}>{t("signup.confirmPassword")}</label>
          <p className="mt-1 text-xs text-red-500">{formik.touched.rePassword && formik.errors.rePassword}</p>
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="mt-6 w-full rounded-lg bg-slate-900 py-2.5 text-white hover:bg-slate-800 focus:ring-2 focus:ring-slate-600 disabled:opacity-70"
        >
          {loading ? <i className="fas fa-spinner fa-spin"></i> : t("signup.submit")}
        </button>
